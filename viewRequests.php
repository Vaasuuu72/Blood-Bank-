...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url(pic/pexels-photo-3786157.jpeg);
            opacity: 0.9;
...
<body>
    ...
    <div class=" requests">
        <div class="header"><h2><b>VIEW REQUESTS</b></h2></div>
        <?php include "db.php";
        $query = "SELECT * from `requests`,`bloodgroup` where requests.bloodGroup = bloodgroup.bloodId ";
            ...
            <div class="col mb-4">
                <div class="card h-100">
                    <div class="card-body">
                      ...
                      <p class="card-text"><h4><b><label for="">Age:</label> <?php echo " ".$row['age']; ?></b></h4></p>
                      ...
                      <p class="card-text"><h4><b><label for="">Requested Date:</label> <?php echo " ".$row['requestDate']; ?></b></h4></p>
                      <p class="card-text"><h4><b><label for="">Details:</label><?php echo " ".$row['detail']; ?></b></h4></p>
                    </div>
                </div>
            </div>
        </div>
