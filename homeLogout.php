...
<body>
  ...
  <div class="section b">
    ...
    <div class="section c">
      <div class="content">
        ...
        <div class="right">
            ...
            <tr>
            <td style="border:2px black solid;"><b>Blood Type</b></td>
            <td style="border:2px black solid;"><b>Donate Blood To</b></td>
            <td style="border:2px black solid;"><b>Receive Blood From</b></td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>A+</b></span></td>
            <td style="border:2px black solid;">A+ AB+</td>
            <td style="border:2px black solid;">A+ A- O+ O-</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>O+</b></span></td>
            <td style="border:2px black solid;">O+ A+ B+ AB+</td>
            <td style="border:2px black solid;">O+ O-</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>B+</b></span></td>
            <td style="border:2px black solid;">B+ AB+</td>
            <td style="border:2px black solid;">B+ B- O+ O-</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>AB+</b></span></td>
            <td style="border:2px black solid;">AB+</td>
            <td style="border:2px black solid;">Everyone</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>A-</b></span></td>
            <td style="border:2px black solid;">A+ A- AB+ AB-</td>
            <td style="border:2px black solid;">A- O-</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>O-</b></span></td>
            <td style="border:2px black solid;">Everyone</td>
            <td style="border:2px black solid;">O-</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>B-</b></span></td>
            <td style="border:2px black solid;">B+ B- AB+ AB-</td>
            <td style="border:2px black solid;">B- O-</td>
            </tr>
            <tr>
            <td style="border:2px black solid;"><span style="color: #961e1b;"><b>AB-</b></span></td>
            <td style="border:2px black solid;">AB+ AB-</td>
            <td style="border:2px black solid;">AB- A- B- O-</td>
            </tr>
            </tbody>
          </table>
	      </div>
    ...
    <div class="section">
      <div class="content">
        <h1 class="f-40   wd-max px-2 ">Ensuring Access to Safe Blood</h1><br>
        <p class=" w-50-lg px-2">
